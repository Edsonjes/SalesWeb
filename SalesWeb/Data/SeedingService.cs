...
namespace SalesWeb.Data
{
    public class SeedingService
    {
        ...
        { 
            ...
            Saller s1 = new Saller(1, "Bob Brown", "bob@gmail.com", new DateTime(1998, 4, 21), 2000.0, d1);
            Saller s2 = new Saller(2, "Maria Green", "maria@gmail.com", new DateTime(1987, 2, 3), 5000.0, d1);
            Saller s3 = new Saller(3, "Alex Grey", "alex@gmail.com", new DateTime(1979, 4, 10), 7000.0, d2);
            Saller s4 = new Saller(4, "Martha Red", "Martha@gmail.com", new DateTime(1986, 10, 22), 15000.0, d4);
